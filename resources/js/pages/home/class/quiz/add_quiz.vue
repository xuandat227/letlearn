...
export default {
    ...
    created() {
        this.unsubscribe = this.$store.subscribe((mutation) => {
            if (mutation.type === 'classQuiz/quizAdded') {
    ...
    methods: {
        ...
        addTest() {
            this.$store.dispatch('classQuiz/addQuiz', {
                class_id: this.$route.params.id,
                name: this.test.name,
                description: this.test.description,
                start_time: this.test.start_time,
                end_time: this.test.end_time,
                questions: this.data,
            });
        }
    }
